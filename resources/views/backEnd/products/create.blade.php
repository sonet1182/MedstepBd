...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Hospitals</a> <a href="{{route('product.create')}}" class="current">Add New Hospital</a> </div>
            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <label class="control-label">Select Place</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="p_code" class="control-label">Website</label>
                    ...
                    <div class="control-group">
                        <label for="p_color" class="control-label">Map Location</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Add New Hospital</button>
                        </div>
                    </div>
                </form>
            </div>
