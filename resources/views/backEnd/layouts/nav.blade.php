...
<div id="sidebar"><a href="{{url('/admin')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu {{$menu_active==3? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Hospitals</span></a>
            <ul>
                <li><a href="{{url('/admin/product/create')}}">Add New Hospital</a></li>
                <li><a href="{{route('product.index')}}">List of Hospitals</a></li>
            </ul>
        </li>
        <!--
