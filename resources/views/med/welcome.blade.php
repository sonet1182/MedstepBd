...
<li class="nav-item cta mr-md-2"><a href="#" class="nav-link">বাংলায় পড়ুন</a></li>
      ...
      <section class="hero-wrap js-fullheight" style="background-image: url('{{ asset('public/med/images/bg_2.jpg') }}');" data-section="home" data-stellar-background-ratio="0.5">
        ...
        <div class="row slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
            <div class="mt-5">
                ...
                <p><a href="{{ url('/#service_section') }}" class="btn btn-primary py-3 px-4">Take your Service</a> </p>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-flex">
                          ...
                          <div class="media-body pl-md-4">
                            <a href="{{ route('appointment') }}"><h3 class="heading mb-3 hv">Emergency Ambulance Services</h3></a>
    ...
    <section class="ftco-intro img" id="provider-section"  style="background-image: url('{{ asset('public/med/images/images.jpg') }}');">
            <div class="overlay"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 text-center">
                        ...
                        <p class="mb-0 hv"><a href="{{ url('/amb_provider') }}" class="btn btn-white px-4 py-3">Click Here</a></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container-fluid px-0">
            <div class="row no-gutters">
                ...
                <div class="col-md-4 d-flex">
                    <div class="img img-dept align-self-stretch" style="background-image: url('{{ asset('public/med/images/dept-1.jpg') }}');"></div>
                </div>
            ...
            <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url('{{ asset('public/med/images/doc-1.jpg') }}' ) ;"></div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url('{{ asset('public/med/images/doc-2.jpg') }}');"></div>
                            </div>
                            <div class="text pt-3 text-center">
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url('{{ asset('public/med/images/doc-3.jpg') }}');"></div>
                            </div>
                            <div class="text pt-3 text-center">
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url('{{ asset('public/med/images/doc-4.jpg') }}');"></div>
                            </div>
                            <div class="text pt-3 text-center">
        ...
        <div class="row d-flex">
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('public/med/images/5f69c5a17dc9b.jpg') }}');">
              </a>
            ...
            <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('public/med/images/image_2.jpg') }}');">
              </a>
              <div class="text d-block">
                <div class="meta mb-3">
                  <div><a href="#">June 9, 2019</a></div>
            ...
            <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('public/med/images/image_3.jpg') }}');">
              </a>
              <div class="text d-block">
                <div class="meta mb-3">
                  <div><a href="#">June 9, 2019</a></div>
            ...
            <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('public/med/images/image_4.jpg') }}');">
              </a>
              <div class="text d-block">
                <div class="meta mb-3">
                  <div><a href="#">June 9, 2019</a></div>
            ...
            <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('public/med/images/image_5.jpg') }}');">
              </a>
              <div class="text d-block">
                <div class="meta mb-3">
                  <div><a href="#">June 9, 2019</a></div>
            ...
            <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('public/med/images/image_6.jpg') }}');">
              </a>
              <div class="text d-block">
                <div class="meta mb-3">
                  <div><a href="#">June 9, 2019</a></div>
    ...
    <section class="ftco-section testimony-section img" style="background-image: url('{{ asset('public/med/images/bg_3.jpg') }}');">
        <div class="overlay"></div>
      <div class="container">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url('{{ asset('public/med/images/diuIcon.png') }}')">
